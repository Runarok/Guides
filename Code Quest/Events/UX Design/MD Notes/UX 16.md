Alright. This lesson is *dense*, but underneath it there are only a few **core mechanics** you actually need to internalize. I’ll organize this **by meaning, not by textbook order**, and only keep what genuinely matters when you’re writing C.

No fixed header count. Only what’s needed.
